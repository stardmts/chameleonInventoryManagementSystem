    ...
    return (
        <main className = "flex flex-col items-center space-y-5 bg-[#323232]">
            ...
            <div className = "flex flex-row items-left w-full px-10"> 
                <input type = "text" value = {search} onChange = {(e) => setSearch(e.target.value)} placeholder = "Search the transactions..." className = "text-white text-left bg-[#484848] w-100 p-2 rounded-full border-b-2 border-white"/>
            </div>
            <div className = "flex flex-col items-center space-y-2 overflow-y-auto bg-[#323232] h-190 w-431 text-white rounded px-5 py-5">
                ...
                <TransactionCard key = "3" transactionId = "63" transactionBody = "signed out 9 size M orange dresses (itemCode: 5032)" transactionDate = "01/07/2026" user = "Claire"/> 
                ...
                <TransactionCard key = "6" transactionId = "106" transactionBody = "signed out 7 size M green dresses (itemCode: 5090)" transactionDate = "01/07/2026" user = "Claire"/> 
                ...
                <TransactionCard key = "8" transactionId = "134" transactionBody = "signed out 7 size M pink dresses (itemCode: 5092)" transactionDate = "01/07/2026" user = "Claire"/> 
                ...
                <TransactionCard key = "10" transactionId = "1454" transactionBody = "signed out 3 size yellow tutus (itemCode: 5096)" transactionDate = "01/07/2026" user = "Claire"/>                             
            </div>
        </main>   
    );
}