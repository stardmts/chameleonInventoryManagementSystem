        ...
        <main className = "flex flex-col items-center space-y-5 bg-[#323232]">
            ...
            <div className = "flex flex-row items-center justify-between w-full px-10">
                ...
                <div className = "flex flex-row space-x-2 px-2">
                    ...
                    <button onClick = {() => router.push('/addUser')} className = "bg-[#323232] border-4 border-[#e97187] p-2 text-white rounded-full hover:bg-[#e97187]"> Add user </button> {/*remove user page*/}
                </div>
            </div>
