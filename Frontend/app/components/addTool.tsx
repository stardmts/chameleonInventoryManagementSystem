    ...
    return (
        <main className = "flex flex-col bg-[#323232] space-y-5 p-5 rounded-[15]">
            <div className = "flex flex-col space-y-2">
                ...
                <input type = "text" value = {category} onChange = {(e) => setCategory(e.target.value)} placeholder = "Enter tool or tech..." className = "text-white text-left bg-[#484848] w-100 p-2 rounded-full border-b-2 border-white"/>
            </div>
