        ...
        <main className = "flex flex-col bg-[#323232] min-h-screen w-full items-center">
            <div className = "fex flex-col space-y-5">
                ...
                <div className = "flex flex-col items-center space-y-2 overflow-y-auto h-auto lg:h-190 w-full lg:w-431 text-white rounded px-5 py-5">
                    <CostumeCard key = '5003' costumeId = {5007} name = "red tutu" group = "red tutus" category = "tutus" colour = "red" size = "child small" quantity = {20} locationCode = "abcdef" lastUpdated = "01/07/2026" notes = "" inStock = {2} imageURL = "5007" cost = "£10.00" qrString=""/>              
                    <CostumeCard key = '5004' costumeId = {5008} name = "red tutu" group = "red tutus" category = "tutus" colour = "red" size = "child medium" quantity = {15} locationCode = "abcdef" lastUpdated = "01/07/2026" notes = "" inStock = {13} imageURL = "5007" cost = "£10.00" qrString=""/>
                    ...
                    <CostumeCard key = '5005' costumeId = {5009} name = "red tutu" group = "red tutus" category = "tutus" colour = "red" size = "child large" quantity = {10} locationCode = "abcdef" lastUpdated = "01/07/2026" notes = "" inStock = {7} imageURL = "5007" cost = "£10.00" qrString=""/>              
                    <CostumeCard key = '5006' costumeId = {5010} name = "red tutu" group = "red tutus" category = "tutus" colour = "red" size = "child extra large" quantity = {5} locationCode = "abcdef" lastUpdated = "01/07/2026" notes = "" inStock = {5} imageURL = "5007" cost = "£10.00" qrString=""/> 
                    <CostumeCard key = '5007' costumeId = {5007} name = "red tutu" group = "red tutus" category = "tutus" colour = "red" size = "S" quantity = {20} locationCode = "abcdef" lastUpdated = "01/07/2026" notes = "" inStock = {2} imageURL = "5007" cost = "£10.00" qrString=""/>
                    ...
                    <CostumeCard key = '5008' costumeId = {5008} name = "red tutu" group = "red tutus" category = "tutus" colour = "red" size = "M" quantity = {15} locationCode = "abcdef" lastUpdated = "01/07/2026" notes = "" inStock = {13} imageURL = "5007" cost = "£10.00" qrString=""/>              
                    <CostumeCard key = '5009' costumeId = {5009} name = "red tutu" group = "red tutus" category = "tutus" colour = "red" size = "L" quantity = {10} locationCode = "abcdef" lastUpdated = "01/07/2026" notes = "" inStock = {7} imageURL = "5007" cost = "£10.00" qrString=""/>
                    ...
                    <CostumeCard key = '5010' costumeId = {5010} name = "red tutu" group = "red tutus" category = "tutus" colour = "red" size = "XL" quantity = {5} locationCode = "abcdef" lastUpdated = "01/07/2026" notes = "" inStock = {5} imageURL = "5007" cost = "£10.00" qrString=""/>
