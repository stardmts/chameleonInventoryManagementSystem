...
export default function SignIn() {
  ...
  return (
    <main className = "flex flex-col lg:flex-row bg-[#262626] min-h-screen w-full px-5 lg:px-20 py-5 lg:py-20 space-y-5 lg:space-y-15 lg:justify-around">
      ...
      <div className = "flex flex-col justify-center items-center h-full bg-[#323232] space-y-5 p-4 lg:p-8 rounded-[10]">
        <a href = "https://www.starlightdance.net/chameleon" target="_blank" rel="noopener noreferrer">
            <img src = "../logos/CHAMELEON_LOGO.svg" className = "w-250" />
        </a>
        <div className = "flex flex-row space-x-5">
            <button onClick={() => router.push('https://www.starlightdance.net/hire-category/costume-hire/')} className = "text-white text-sm lg:text-2xl bg-[#6ab51c] rounded-[15] py-4 px-4 shadow-2xl hover:bg-[#484848]"> View our catalogue </button>
            <button onClick={() => router.push('/contactUs')} className = "text-white text-sm lg:text-2xl bg-[#6ab51c] rounded-[15] p-8 shadow-2xl hover:bg-[#484848]"> Contact us </button>
        </div>
      </div>
    </main>
  );
